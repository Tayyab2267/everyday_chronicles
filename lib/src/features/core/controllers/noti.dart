...
class Noti {
  ...
  static Future<void> prayerMethod(String prayerName) async {
    ...
    String? requiredPrayerList =
        await SQLHelper.getPrayerListByDate(presentDate);
  ...
  static Future<void> showNotification({
    ...
    assert(!scheduled || (scheduled && interval != null),
        'Interval must not be null when scheduling a notification.');

    if (scheduled && interval == null) {
      print("Error: Interval must be provided for scheduled notifications.");
      return;
    }
      ...
      schedule: scheduled
          ? NotificationInterval(
              interval: interval != null
                  ...
                  : Duration.zero, // Convert int to Duration
              timeZone:
