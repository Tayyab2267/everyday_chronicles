...
class CardTraditionalScreen extends StatefulWidget {
  ...
  final Color color;
  final String cardID, cardDate, cardTitle, cardSubTitle, cardThoughts, cardText;
                          ...
                          onPressed: () {
                            setState(() {
                              ...
                              if (isSubtitleVisible) {
                                subtitleController.text = widget.cardSubTitle;//'Initial subtitle value';
                              }
                          ...
                          onPressed: () {
                            setState(() {
                              ...
                              if (isThoughtsVisible) {
                                thoughtsController.text = widget.cardThoughts;//'Initial 3am thoughts';
                              }
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: isSubtitleVisible ? 'Subtitle is empty' : '3am Thoughts is empty',
                        ),
                      ),
                    ),
                ],
