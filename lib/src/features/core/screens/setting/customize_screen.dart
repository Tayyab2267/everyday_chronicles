  ...
  Future<void> _loadPreferences() async {
    ...
    setState(() {
      ...
      _locationServiceEnabled =
          _prefs.getBool('locationServiceEnabled') ?? false;
      _mobileUsageServiceEnabled =
          _prefs.getBool('mobileUsageServiceEnabled') ?? false;
      _messageServiceEnabled = _prefs.getBool('messageServiceEnabled') ?? false;
      _callLocationServiceEnabled =
          _prefs.getBool('callLocationServiceEnabled') ?? false;
